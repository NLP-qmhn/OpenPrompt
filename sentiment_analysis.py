...
processor = NLPCC14_SC()

trainset = processor.get_train_examples("datasets/NLPCC14-SC/split_data")
validset = processor.get_valid_examples("datasets/NLPCC14-SC/split_data")
testset = processor.get_test_examples("datasets/NLPCC14-SC/split_data")
...
validation_dataloader = PromptDataLoader(dataset=validset, template=mytemplate, tokenizer=tokenizer,
    tokenizer_wrapper_class=WrapperClass, max_seq_length=256, decoder_max_length=8,
    batch_size=16, shuffle=False, teacher_forcing=False, predict_eos_token=False,
    truncate_method="head")

test_dataloader = PromptDataLoader(dataset=testset, template=mytemplate, tokenizer=tokenizer,
    tokenizer_wrapper_class=WrapperClass, max_seq_length=256, decoder_max_length=8,
    batch_size=16, shuffle=False, teacher_forcing=False, predict_eos_token=False,
    truncate_method="head")
